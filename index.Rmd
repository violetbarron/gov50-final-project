...
regression_data = data.frame(asian = c(0.592, 0.273),
                             general = 0.357)
model = lm(general ~ asian, regression_data)
...
The percentage of Americans who hold a bachelor's degree or higher is 35.7% (2020 U.S. Census). The "aggregate" percentage of the AANHPI population, when measured between Chinese Americans and Hmong Americans, who hold a bachelor's degree or higher is 43.25%. Running a regression on these percentages produces a coefficient of 0.357, a positive, relatively insignificant coefficient, which I hypothesized we would find. This coefficient proves that the aggregate AANHPI level of educational attainment is somewhere in between that of the average citizen, effectively proving that AANHPI population is not a monolith (i.e. fares much better or much worse than the general U.S. population), at least when it comes to educational attainment.
